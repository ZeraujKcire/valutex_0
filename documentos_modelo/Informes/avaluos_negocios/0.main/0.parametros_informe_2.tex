...
%---------------Datos del bien sujeto de valuaci\'on
...
\newcommand{\betaDesapalancada}{insertar}
\newcommand{\betaReapalancada}{insertar}
...
\newcommand{\valorBeneficioFiscal}{insertar}
\newcommand{\valorBeneficioFiscalLetra}{insertar} 
