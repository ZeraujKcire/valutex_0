...
\usepackage{fontspec,xltxtra,xunicode} %fuentes Stolzl
\defaultfontfeatures{Mapping=tex-text}
\setromanfont[Mapping=tex-text]{Stolzl}
\setsansfont[Scale=MatchLowercase,Mapping=tex-text]{Stolzl}
\setmonofont[Scale=MatchLowercase]{Stolzl}

\usepackage{paracol}  %multiples columnas en paralelo
...
%-----------------Espacio en blanco--------------------
\newcommand{\espacio}[1]{\vspace{#1}\begin{center}\textit{[ESPACIO EN BLANCO]}\end{center}\newpage}
