...
%\rowcolor{principal}
\includegraphics[width=5cm]{\rutaImagenes/logo_valuami_fondo_blanco} &\includegraphics[width=2.5cm]{\rutaImagenes/isotipo_valuami}\\
\end{tabular}
}
...
\backgroundsetup{angle=0, contents={\includegraphics[width=21.5cm]{\rutaImagenes/background_valuami_previo}},opacity=.3, scale=1}
