...
%\rowcolor{principal}
\includegraphics[width=5cm]{\rutaImagenes/avanza_logo} &%\includegraphics[width=2.5cm]{\rutaImagenes/isotipo_valuami}
\\
\end{tabular}
}
...
\backgroundsetup{angle=0, contents={\includegraphics[width=21.5cm]{\rutaImagenes/avanza_logo}},opacity=.3, scale=1}
